...
public class Main {
    ...
    {
        //if (event.getTabKey() == ModTabs.TRAINUTILS_TAB)
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event)
        {
            ...
            //.setRenderLayer(BlockInit.FRAMELESS_GLASS.get(), RenderType.translucent());
            //.setRenderLayer(BlockInit.FRAMELESS_GLASS.get(), RenderType.cutout());
        }
    }
}
